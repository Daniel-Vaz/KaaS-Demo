...
This Code of Conduct applies to everyone participating in KubeHarbor - issues, pull requests, code
review, discussions, and any other project space. **Community Moderators**, below, means the project
...
[private reporting form](https://github.com/Daniel-Vaz/KaaS-Demo/security/advisories/new)**. That
form is GitHub's security-advisory channel, used here because it is the project's only private,
authenticated route to the maintainers - a conduct report sent through it is treated as a conduct
report, not a vulnerability. Please do not raise conduct concerns in a public issue or pull request.

If your report concerns a maintainer, or you would rather not contact the maintainers at all, report
it to GitHub directly through [Report abuse](https://github.com/contact/report-abuse).
